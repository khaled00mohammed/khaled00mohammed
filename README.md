...
* ⚡ Currently focusing on advanced **Vue 3 (Composition API)**, responsive layout architectures, and interactive web apps.
* 🎨 Deeply interested in **UI/UX Design**, creating scalable vector assets, and bridging the gap between design and clean code.
* 🚀 Building high-performance SaaS products and custom e-commerce web experiences.
